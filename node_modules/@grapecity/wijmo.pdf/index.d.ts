...
import { Color, EventArgs, Point, Event, Size, Rect } from '@grapecity/wijmo';
...
export declare class _SvgTextElementImpl extends _SvgTextElementBase {
    constructor(ctx: _ISvgRenderContext, node: SVGElement);
    protected _renderContent(): void;
    private _prepareNodes;
}
export declare class _SvgTspanElementImpl extends _SvgTextElementBase {
    _text: string;
    _cx: number;
    _cy: number;
    private _decorators;
